...
public class ExternalApplicationController : Singleton<ExternalApplicationController>
{
    ...
    public void StartMegamolInstance(string projectFile)
    {
        //Check if others are running and kill
        ...
        startInfo.Arguments = "-p \"" + projectFile + "\" -i Project_1 inst"; // mmconsole.exe started with arguments for project file generated by MegaMolConfigurator
