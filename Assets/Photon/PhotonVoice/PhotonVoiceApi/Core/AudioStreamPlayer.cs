...
namespace Photon.Voice
{
    ...
    public class AudioStreamPlayer : Photon.Voice.IAudioOut
    {
        ...
        private Photon.Voice.ISyncAudioOut audioOut;
        private bool audioOutStarted;
        private string logPrefix;
        private bool debugInfo;
        public AudioStreamPlayer(Photon.Voice.ILogger logger, Photon.Voice.ISyncAudioOut audioOut, string logPrefix, bool debugInfo)
        {
            this.logger = logger;
