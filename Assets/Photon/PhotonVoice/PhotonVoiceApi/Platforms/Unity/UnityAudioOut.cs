...
namespace Photon.Voice.Unity
{
    ...
    public class UnityAudioOut : Photon.Voice.ISyncAudioOut
    {
        private int bufferSamples;
        private int streamSamplePos; // TODO: rename to inputSamplePos
        ...
        Photon.Voice.PrimitiveArrayPool<float> framePool = new Photon.Voice.PrimitiveArrayPool<float>(FRAME_POOL_CAPACITY, "UnityAudioOut");
