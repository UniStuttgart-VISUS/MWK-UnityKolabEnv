...
public class UnityIntInteraction : AbstractInteraction<int> { }
public class UnityFloatInteraction : AbstractInteraction<float> { }
public class UnityEnumInteraction : AbstractInteraction<List<string>> { }
public class UnityVector3Interaction : AbstractInteraction<Vector3> { }